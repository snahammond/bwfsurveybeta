...
public class ViewSWEMonthlyTotalSummaryActivity extends AppCompatActivity {
    SWEMonthlyTotalSummary theSWEMonthlyTotalSummary;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().getStringExtra("UUID")!=null)
            uuidSWEMonthlyTotalSummary = getIntent().getStringExtra("UUID");
    ...
    private void initView() {
        ...
        createSWEMonthlyTotalSummaryViewOnlyInterchanges();
    }

    private void createSWEMonthlyTotalSummaryViewOnlyInterchanges() {
        ...
        Amplify.DataStore.query(
                ...
                sweMonthlySummary -> {
                    ...
                    while (sweMonthlySummary.hasNext()) {
                        theSWEMonthlyTotalSummary = sweMonthlySummary.next();
                        Log.i("Tutorials", "DataStore is queried. theSWEMonthlyTotalSummary " +theSWEMonthlyTotalSummary.getId());
                    }
    ...
    private void createViewOnlyInterchangesAndShow() {
        if(theSWEMonthlyTotalSummary!=null){
            ...
            for(int i=0;i<returnedInterchanges.size();i++){
                ...
                try {
                    method = theSWEMonthlyTotalSummary.getClass().getMethod(methodName);
                    Object ansObject = method.invoke(theSWEMonthlyTotalSummary);
                    if(ansObject!=null)
    ...
    private void initViewElements() {
        ...
        adapter = new ViewOnlyInterchangeCardAdapter(ViewSWEMonthlyTotalSummaryActivity.this, ViewSWEMonthlyTotalSummaryActivity.viewOnlyInterchanges);
