...
public class ViewSWEMonthlySummaryActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        createSWEMonthlySummaryViewOnlyInterchanges();
    }

    private void createSWEMonthlySummaryViewOnlyInterchanges() {
    ...
    private void initViewElements() {
        ...
        adapter = new ViewOnlyInterchangeCardAdapter(ViewSWEMonthlySummaryActivity.this, ViewSWEMonthlySummaryActivity.viewOnlyInterchanges);
