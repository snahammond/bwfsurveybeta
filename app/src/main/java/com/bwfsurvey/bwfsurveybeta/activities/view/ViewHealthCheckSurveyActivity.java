...
public class ViewHealthCheckSurveyActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        createHealthCheckSurveyViewOnlyInterchanges();
    }

    private void createHealthCheckSurveyViewOnlyInterchanges() {
    ...
    private void createViewOnlyInterchangesAndShow() {
        if(theHealthCheckSurvey!=null){
            ArrayList<Interchange> returnedInterchanges = MyAmplifyApplication.getInterchanges("HEALTHCHECKSURVEY");
    ...
    private void initViewElements() {
        ...
        adapter = new ViewOnlyInterchangeCardAdapter(ViewHealthCheckSurveyActivity.this, ViewHealthCheckSurveyActivity.viewOnlyInterchanges);
