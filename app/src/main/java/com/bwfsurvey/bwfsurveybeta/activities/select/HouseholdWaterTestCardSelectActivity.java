...
public class HouseholdWaterTestCardSelectActivity extends AppCompatActivity {
            ...
            Amplify.DataStore.query(
                    ...
                    allHouseholdWaterTest -> {
                        ...
                        while (allHouseholdWaterTest.hasNext()) {
                            ...
                            Amplify.API.mutate(
                                    ModelMutation.create(aHouseholdWaterTest),
                                    response -> {
                                    },
                                    error -> {
                                    }
    ...
    private void showListOflistOfHouseholdWaterTests() {
        if(listOfHouseholdWaterTest.size()>0){
            ...
            String msg = "No data for household water test found.";
            if(operation.contentEquals("UPDATE")){
                msg = "No suspended data for household water test found.";
            }else if(operation.contentEquals("VIEW")){
                msg = "No data for household water test found.";
            }
            ListUtils.showZeroListAlert(msg,HouseholdWaterTestCardSelectActivity.this);
        }
