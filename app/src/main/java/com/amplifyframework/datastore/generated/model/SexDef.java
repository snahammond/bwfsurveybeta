...
/** This is an auto generated class representing the SexDef type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "SexDefs")
public final class SexDef implements Model {
  ...
  private SexDef(String id, String fieldName, String fieldDescription) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      SexDef sexDef = (SexDef) obj;
      return ObjectsCompat.equals(getId(), sexDef.getId()) &&
              ObjectsCompat.equals(getFieldName(), sexDef.getFieldName()) &&
              ObjectsCompat.equals(getFieldDescription(), sexDef.getFieldDescription());
      }
  }
   ...
   */
  public static SexDef justId(String id) {
    try {
