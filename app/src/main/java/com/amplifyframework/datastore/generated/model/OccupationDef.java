...
/** This is an auto generated class representing the OccupationDef type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "OccupationDefs")
public final class OccupationDef implements Model {
  ...
  private OccupationDef(String id, String fieldName, String fieldDescription) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      OccupationDef occupationDef = (OccupationDef) obj;
      return ObjectsCompat.equals(getId(), occupationDef.getId()) &&
              ObjectsCompat.equals(getFieldName(), occupationDef.getFieldName()) &&
              ObjectsCompat.equals(getFieldDescription(), occupationDef.getFieldDescription());
      }
  }
   ...
   */
  public static OccupationDef justId(String id) {
    try {
