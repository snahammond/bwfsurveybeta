...
/** This is an auto generated class representing the IntervieweeDef type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "IntervieweeDefs")
public final class IntervieweeDef implements Model {
  ...
  private IntervieweeDef(String id, String fieldName, String fieldDescription) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      IntervieweeDef intervieweeDef = (IntervieweeDef) obj;
      return ObjectsCompat.equals(getId(), intervieweeDef.getId()) &&
              ObjectsCompat.equals(getFieldName(), intervieweeDef.getFieldName()) &&
              ObjectsCompat.equals(getFieldDescription(), intervieweeDef.getFieldDescription());
      }
  }
   ...
   */
  public static IntervieweeDef justId(String id) {
    try {
