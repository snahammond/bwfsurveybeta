...
/** This is an auto generated class representing the MaritalStatusDef type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "MaritalStatusDefs")
public final class MaritalStatusDef implements Model {
  ...
  private MaritalStatusDef(String id, String fieldName, String fieldDescription) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      MaritalStatusDef maritalStatusDef = (MaritalStatusDef) obj;
      return ObjectsCompat.equals(getId(), maritalStatusDef.getId()) &&
              ObjectsCompat.equals(getFieldName(), maritalStatusDef.getFieldName()) &&
              ObjectsCompat.equals(getFieldDescription(), maritalStatusDef.getFieldDescription());
      }
  }
   ...
   */
  public static MaritalStatusDef justId(String id) {
    try {
