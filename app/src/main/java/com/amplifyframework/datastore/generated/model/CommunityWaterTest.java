...
@ModelConfig(pluralName = "CommunityWaterTests")
public final class CommunityWaterTest implements Model {
  ...
  private CommunityWaterTest(String id, String Namebwe, Temporal.Date date, String Country, String Community, Temporal.Date ColilertDateTested, Temporal.Date ColilertDateRead, String ColilertTestResult, Temporal.Date PetrifilmDateTested, Temporal.Date PetrifilmDateRead, String PetrifilmTestResult) {
    this.id = id;
  ...
  public interface PetrifilmTestResultStep {
    BuildStep petrifilmTestResult(String petrifilmTestResult);
  }
  ...
  public static class Builder implements NamebweStep, CountryStep, CommunityStep, ColilertDateTestedStep, ColilertDateReadStep, ColilertTestResultStep, PetrifilmDateTestedStep, PetrifilmDateReadStep, PetrifilmTestResultStep, BuildStep {
    private String id;
    ...
    @Override
     public BuildStep petrifilmTestResult(String petrifilmTestResult) {
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String namebwe, Temporal.Date date, String country, String community, Temporal.Date colilertDateTested, Temporal.Date colilertDateRead, String colilertTestResult, Temporal.Date petrifilmDateTested, Temporal.Date petrifilmDateRead, String petrifilmTestResult) {
      super.id(id);
