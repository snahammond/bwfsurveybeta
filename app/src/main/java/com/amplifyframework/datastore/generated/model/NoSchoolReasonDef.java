...
/** This is an auto generated class representing the NoSchoolReasonDef type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "NoSchoolReasonDefs")
public final class NoSchoolReasonDef implements Model {
  ...
  private NoSchoolReasonDef(String id, String fieldName, String fieldDescription) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      NoSchoolReasonDef noSchoolReasonDef = (NoSchoolReasonDef) obj;
      return ObjectsCompat.equals(getId(), noSchoolReasonDef.getId()) &&
              ObjectsCompat.equals(getFieldName(), noSchoolReasonDef.getFieldName()) &&
              ObjectsCompat.equals(getFieldDescription(), noSchoolReasonDef.getFieldDescription());
      }
  }
   ...
   */
  public static NoSchoolReasonDef justId(String id) {
    try {
  ...
  public static class Builder implements FieldNameStep, FieldDescriptionStep, BuildStep {
    ...
    @Override
     public NoSchoolReasonDef build() {
